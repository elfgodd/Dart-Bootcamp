void main() {
  ...
  // This is an Error we can't create a Class from
  // an Abstract class
  // Person persona = Person();
  
}

// Create Abstract class when we have a Parent or Main class to extend
// to share only the data through the inheritance
